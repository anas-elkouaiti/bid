(function ($) {
    ...
    /*
    function makeTimer() {
      var endTime = new Date("September 11, 2022 10:00:00");
    ...
    var setEndDate1 = "September 12, 2022 0:0:0";
    ...
    function countDownTimer(start, targetDOM) {
      ...
      if (distance < 0) {
        if(document.querySelector("#" + targetDOM) != null)
    ...
    */
    ...
    const togglePassword2 = document.getElementById("togglePassword_login");
    const password2 = document.querySelector("#password_login");
    if (togglePassword2) {
    ...
    const togglePassword3 = document.getElementById("togglePassword_update_1");
    const password3 = document.querySelector("#old_password_update");
    if (togglePassword3) {
    ...
    const togglePassword4 = document.getElementById("togglePassword_update_2");
    const password4 = document.querySelector("#new_password_update");
    if (togglePassword4) {
    ...
    const togglePassword5 = document.getElementById("togglePassword_update_3");
    const password5 = document.querySelector("#confirm_password_update");
    if (togglePassword5) {
