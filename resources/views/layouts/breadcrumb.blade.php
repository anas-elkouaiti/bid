...
<body>
    ...
    <div class="inner-banner">
        <div class="container">
            <h2 class="inner-banner-title">@yield('breadcrumb')</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">@lang('labels.navbar-home')</a></li>
    ...
    <script src="{{ asset('js/verifica_update.js') }}"></script>
    <script src="{{ asset('js/verifica_search.js') }}"></script>
    <script src="{{ asset('js/timer.js') }}"></script>
    <script src="{{ asset('js/verifica_bid.js') }}"></script>
